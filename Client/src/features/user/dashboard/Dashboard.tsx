...
import { Calendar, Target, Award, Plus, Edit3, BarChart3, Heart } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center mb-4 md:mb-0">
              <img src={user.avatar} alt="Profile" className="w-16 h-16 rounded-full border-4 border-blue-100" />
              <div className="ml-4">
