    ...
    if (id) {
      ...
      if (productToEdit) {
        setFormData({
          ...
          calories: (productToEdit.calories || 0).toString(),
          protein: (productToEdit.protein || 0).toString(),
          carbs: (productToEdit.carbs || 0).toString(),
          fat: (productToEdit.fat || 0).toString(),
          fiber: (productToEdit.fiber || 0).toString(),
        });
