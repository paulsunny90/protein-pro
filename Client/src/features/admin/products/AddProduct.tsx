    ...
    <div className="min-h-screen bg-slate-50/50 p-6 md:p-12">
      <div className="max-w-5xl mx-auto">
        <header className="mb-10 animate-fade-in">
          ...
          <h1 className="text-4xl font-black text-slate-900 tracking-tight mb-3">Add New Product</h1>
          <p className="text-lg text-slate-500 font-medium">Create a new listing in your store ecosystem.</p>
        </header>
              ...
              {previewUrls.length < 5 && (
                <label htmlFor="image-upload" className="block w-full p-6 rounded-2xl border-2 border-dashed border-slate-200 hover:border-indigo-400 hover:bg-slate-50 transition-all cursor-pointer text-center">
                  ...
                  <span className="text-sm font-bold text-slate-600">
                    {previewUrls.length === 0 ? 'Click to Upload Images' : `Add More (${previewUrls.length}/5)`}
                  </span>
